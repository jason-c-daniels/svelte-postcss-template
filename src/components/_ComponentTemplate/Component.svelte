...
<div class="component-template">
    <h2>A Component Template</h2>
    <p>
        This is a template directory and set of files for creating new components.
    ...
    <p>
        As well, please consider renaming these files from "Component.*" to the directory name.
